...
namespace JqueryApp
{
    public class SQLiteHelper
    {
        ...
        /// <summary>
        /// 执行存储过程  (使用该方法切记要手工关闭SQLiteDataReader和连接)
        /// </summary>
        ...
        public static SQLiteCommand BuildQueryCommand(SQLiteConnection connection, string storedProcName, IDataParameter[] parameters)
        {
        ...
        public static SQLiteCommand BuildIntCommand(SQLiteConnection connection, string storedProcName, IDataParameter[] parameters)
        {
            SQLiteCommand command = BuildQueryCommand(connection, storedProcName, parameters);
